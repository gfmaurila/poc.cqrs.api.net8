...
SQLServerInitializer.Initialize(builder.Services, builder.Configuration);
OracleInitializer.Initialize(builder.Services, builder.Configuration);
MySQLInitializer.Initialize(builder.Services, builder.Configuration);
...
app.MapControllers();
app.Logger.LogInformation("----- Iniciando a aplicação - RH...");
