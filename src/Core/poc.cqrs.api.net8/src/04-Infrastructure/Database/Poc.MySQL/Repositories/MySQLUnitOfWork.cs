...
{
    private readonly MySQLContext _writeDbContext;
    private readonly IEventMKTCommandStore _eventCoreRepository;
    private readonly IMediator _mediator;
    private readonly ILogger<MySQLUnitOfWork> _logger;

    public MySQLUnitOfWork(
        MySQLContext writeDbContext,
        IEventMKTCommandStore eventCoreRepository,
        IMediator mediator,
    ...
    private (IEnumerable<Event> domainEvents, IEnumerable<EventMKTModel> eventCores) BeforeSaveChanges()
    {
        ...
        var eventCores = new List<EventMKTModel>();
        ...
        if (domainEntities.Any())
        {
            ...
            foreach (var @event in domainEvents)
            {
                ...
                eventCores.Add(new EventMKTModel(aggregateId, messageType, data));
            }
    ...
    private async Task AfterSaveChangesAsync(IEnumerable<Event> domainEvents, IEnumerable<EventMKTModel> eventCores)
    {
