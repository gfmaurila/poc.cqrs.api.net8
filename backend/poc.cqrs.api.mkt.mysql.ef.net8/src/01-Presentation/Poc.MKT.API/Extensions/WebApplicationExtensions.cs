...
namespace Poc.MKT.API.Extensions;
...
public static class WebApplicationExtensions
{
    public static async Task MigrateAsync(this WebApplication app)
    {
        ...
        await using var writeDbContext = serviceScope.ServiceProvider.GetRequiredService<MySQLContext>();
        try
        {
    ...
    public static void UseDevelopmentSwagger(this IApplicationBuilder app)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "Poc.MKT.API");
        });
    }
    ...
    public static void AddHealthChecks(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var healthCheckBuilder = services
            .AddHealthChecks()
            .AddDbContextCheck<MySQLContext>(tags: HealthCheckTags.DatabaseTags)
